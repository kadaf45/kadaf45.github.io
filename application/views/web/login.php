					...
					<form action="" method="post">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img src="assets/babar.jpg" alt="Logo Surat Menyurat" width="70"></div>
								<h5 class="content-group">GO-MAIL<small class="display-block">Aplikasi Pengiriman dan Arsip Surat</small></h5>
								<?php
