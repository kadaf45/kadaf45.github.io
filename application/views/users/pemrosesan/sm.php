          ...
          <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="users/sm/d/<?php echo $baris->id_sk; ?>" class="btn btn-default btn-xs"><i class="icon-eye"></i></a>
                    
                    <?php
                    if ($user->row()->level == 'admin') { ?>
                    <a href="users/sm/e/<?php echo $baris->id_sk; ?>" class="btn btn-success btn-xs"><i class="icon-pencil7"></i></a>
                    <a href="users/sm/h/<?php echo $baris->id_sk; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
